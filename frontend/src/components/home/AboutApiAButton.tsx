                ...
                <div className="grid lg:grid-cols-2 gap-2 xxs:gap-4 sm:gap-6 lg:gap-16">
                    <div className="text-center">
                        <div className="px-3 lg:px-0 2xl:px-2">
                            <h1 className="text-2xl xxs:text-3xl xs:text-3xl sm:text-5xl lg:text-3xl xl:text-4xl 2xl:text-6xl font-semibold text-white">
                                Discover the Ultimate Pokémon API
                            </h1>
                        </div>
                        <div className="px-2 xs:px-6 lg:px-0 xl:px-8 2xl:px-16 mt-2 sm:mt-3 lg:mt-3 2xl:mt-4 ">
                            <p className="text-xs xxs:text-sm xs:text-sm sm:text-base lg:text-base xl:text-xl 2xl:text-3xl text-gray-200">
                    ...
                    <div className="h-[55vh] xxs:h-[53vh] xs:h-[67vw] sm:h-[82vw] lg:h-auto 2xl:h-[700px]">
                        <img 
                            src={Pokemons} 
                            alt="Pokemons" 
                            className="w-full h-full object-cover object-[20%_80%] xs:object-[20%_65%] sm:object-[20%_100%] lg:object-[20%_30%] 2xl:object-[40%_30%] rounded-4xl"
                        />
                    </div>
                </div>
            </SheetContent>
